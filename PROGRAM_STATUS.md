...
Last verified: `2026-08-25T05:14:23Z`. HEADs are the verified default-branch revisions, not an assumption about later changes.
...
| 5 | [context-firewall](https://github.com/opsle/context-firewall) | concept | `e865644e86a3` | `THEORY` | [none; placeholder source directory only](https://github.com/opsle/context-firewall/blob/e865644e86a3f820a120548e91284c048e515671/THEORY.md); placeholder only; no automated tests | No executable reducer, conformance suite, frozen fixtures, or correctness oracle. | Implement a dependency-free test-output reducer and synthetic conformance fixtures for EXP-001 without provider use. | `decision-evidence-protocol`, `agent-trajectory-profiler` | active |
...
| 17 | [research](https://github.com/opsle/research) | program infrastructure | `20a48bbad179` | `SPECIFIED` | [public program material present; machine registry and validator are introduced by this bootstrap branch, not the verified default-branch HEAD](https://github.com/opsle/research/blob/20a48bbad1794c726e2f02bf5da7415d5e7674f8/METHODOLOGY.md); no registry validator at the verified default-branch HEAD | Program-control bootstrap must be reviewed and merged before the default branch becomes authoritative. | Review and merge the program-control bootstrap after CI passes. | — | active |
...
EXP-001 prerequisites: Context Firewall reducer plus Decision Evidence receipts and Trajectory Profiler payload fixtures.

`EXP-001` — **PLANNED** — How much context can an AI coding agent safely not see?

Blockers: No executable Context Firewall reducer or conformance suite exists. Fixture identities, correctness oracle, harness, and exact configurations are not frozen.

## Exact recommended next execution

Implement a dependency-free Context Firewall test-output reducer and synthetic conformance fixtures that emit Decision Evidence Protocol-compatible receipts and Agent Trajectory Profiler-compatible payload measurements; do not run a model/provider experiment.
